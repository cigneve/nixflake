{
  ...
  linuxPackages = pkgs.linuxPackages_6_11;
...
in {
  imports = [
    ...
    ./disko.nix
    flakeModules.zram.base
    flakeModules.laptop.base
    flakeModules.network.base
    flakeModules.graphical.base
    flakeModules.misc.yubikey
    flakeModules.misc.logitech
    flakeModules.studio.base
    ../../users/baba
    ../../users/root
  ];
  ...
  #  aboot.kernelPatches = (map (patch: {inherit patch; }) [
