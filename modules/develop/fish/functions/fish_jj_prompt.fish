# Taken from https://github.com/fish-shell/fish-shell/issues/11183
            ...
            --template '
                surround(
                    ...
                    separate(
                        ...
                        change_id.shortest(),
                        commit_id.shortest(),
                        if(conflict, label("conflict", "conf")),
                        if(divergent, label("divergent", "div")),
                        if(hidden, label("hidden prefix", "(hidden)")),
                        if(immutable, label("node immutable", "im")),
                        coalesce(
                            if(
                                empty,
                                coalesce(
